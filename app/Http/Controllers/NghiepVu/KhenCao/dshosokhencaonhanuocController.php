...
class dshosokhencaonhanuocController extends Controller
{
    public static $url = '/KhenCao/NhaNuoc/';
    ...
    {
        if (!chkPhanQuyen('dshosokhencaonhanuoc', 'danhsach')) {
        ...
        $inputs['capdo'] = 'TW';
        $m_donvi = getDonVi(session('admin')->capdo, 'dshosokhencaonhanuoc');
        if (count($m_donvi) == 0) {
            return view('errors.noperm')
                ->with('machucnang', 'dshosokhencaonhanuoc')
                ->with('tenphanquyen', 'danhsach');
    ...
    {
        if (!chkPhanQuyen('dshosokhencaonhanuoc', 'thaydoi')) {
            return view('errors.noperm')
                ->with('machucnang', 'dshosokhencaonhanuoc')
    ...
    public function XemHoSo(Request $request)
    {
        ...
        return view('NghiepVu.KhenCao.NhaNuoc.Xem')
            ->with('model', $model)
            ->with('model_canhan', $model_canhan)
            ->with('model_tapthe', $model_tapthe)
            ->with('m_donvi', $m_donvi)
    ...
    public function InHoSoKT(Request $request)
    {
        ...
        return view('NghiepVu.KhenCao.NhaNuoc.InHoSoKT')
            ->with('model', $model)
            ->with('model_canhan', $model_canhan)
            ->with('model_tapthe', $model_tapthe)
            ->with('m_donvi', $m_donvi)
    ...
    {
        if (!chkPhanQuyen('dshosokhencaonhanuoc', 'hoanthanh')) {
            return view('errors.noperm')
                ->with('machucnang', 'dshosokhencaonhanuoc')
