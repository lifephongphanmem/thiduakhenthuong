...
class xdhosodenghikhencaoController extends Controller
{
    public static $url = '';
    public function __construct()
    {
        static::$url = '/KhenCao/XetDuyetHoSoDN/';
    ...
    {
        if (!chkPhanQuyen('xdhosodenghikhencao', 'danhsach')) {
        ...
        //dd($model);
        //dd($inputs);
        $inputs['trangthai'] = session('chucnang')['xdhosodenghikhencao']['trangthai'] ?? 'CC';
        $inputs['trangthai'] = $inputs['trangthai'] != 'ALL' ? $inputs['trangthai'] : 'CC';
        return view('NghiepVu.KhenCao.XetDuyetHoSoDN.ThongTin')
            ->with('model', $model)
    ...
    {
        if (!chkPhanQuyen('xdhosodenghikhencao', 'hoanthanh')) {
    ...
    public function XetKT(Request $request)
    {
        if (!chkPhanQuyen('xdhosodenghikhencao', 'thaydoi')) {
            return view('errors.noperm')
                ->with('machucnang', 'xdhosodenghikhencao')
