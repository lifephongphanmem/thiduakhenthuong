...
class tnhosodenghikhenthuongchuyendeController extends Controller
{
    public static $url = '/KhenThuongChuyenDe/TiepNhan/';
    ...
    {
        if (!chkPhanQuyen('tnhosodenghikhenthuongchuyende', 'danhsach')) {
            return view('errors.noperm')->with('machucnang', 'tnhosodenghikhenthuongchuyende')->with('tenphanquyen', 'danhsach');
        }
        $inputs = $request->all();
        $inputs['url_hs'] = '/KhenThuongChuyenDe/HoSo/';
        $inputs['url_xd'] = '/KhenThuongChuyenDe/TiepNhan/';
        ...
        $m_donvi = getDonVi(session('admin')->capdo, 'tnhosodenghikhenthuongchuyende');
        ...
        $inputs['maloaihinhkt'] = session('chucnang')['tnhosodenghikhenthuongchuyende']['maloaihinhkt'] ?? 'ALL';
        ...
        return view('NghiepVu.KhenThuongChuyenDe.TiepNhan.ThongTin')
            ->with('model', $model)
    ...
    {
        if (!chkPhanQuyen('tnhosodenghikhenthuongchuyende', 'hoanthanh')) {
            return view('errors.noperm')->with('machucnang', 'tnhosodenghikhenthuongchuyende')->with('tenphanquyen', 'hoanthanh');
        }
        $inputs = $request->all();
