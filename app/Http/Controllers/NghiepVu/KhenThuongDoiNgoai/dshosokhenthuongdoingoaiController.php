...
class dshosokhenthuongdoingoaiController extends Controller
{
    public static $url = '/KhenThuongDoiNgoai/HoSoKT/';
    ...
    {
        if (!chkPhanQuyen('dshosokhenthuongdoingoai', 'danhsach')) {
            return view('errors.noperm')->with('machucnang', 'dshosokhenthuongdoingoai')->with('tenphanquyen', 'danhsach');
        }
        $inputs = $request->all();
        ...
        $inputs['maloaihinhkt'] = session('chucnang')['dshosokhenthuongdoingoai']['maloaihinhkt'] ?? 'ALL';
        $inputs['trangthai'] = session('chucnang')['dshosokhenthuongdoingoai']['trangthai'] ?? 'CC';
        ...
        $inputs['url'] = '/DungChung/HoSoKT/DonViCapDuoi?madonvi=' . $inputs['madonvi'] . '&maloaihinhkt=' . $inputs['maloaihinhkt'] . '&phanloai=dshosokhenthuongdoingoai';
        $inputs['url_hsdv'] = '/DonVi/SapNhap/HoSoKT?madonvi=' . $inputs['madonvi'] . '&maloaihinhkt=' . $inputs['maloaihinhkt'] . '&phanloai=dshosokhenthuongdoingoai';
        $donvi_sapnhap = donvisapnhap::where('madonvi_sapnhap', $inputs['madonvi'])->get();
        $inputs['donvisapnhap'] = count($donvi_sapnhap) > 0 ? true : false;
        //dd($model);
        return view('NghiepVu.KhenThuongDoiNgoai.HoSoKT.ThongTin')
            ->with('model', $model)
    ...
    public function ThayDoi(Request $request)
    {
        if (!chkPhanQuyen('dshosokhenthuongdoingoai', 'thaydoi')) {
            return view('errors.noperm')->with('machucnang', 'dshosokhenthuongdoingoai')->with('tenphanquyen', 'thaydoi');
        }
        $inputs = $request->all();
        $inputs['url'] = '/KhenThuongDoiNgoai/HoSoKT/';
        $inputs['url_hs'] = '/KhenThuongDoiNgoai/HoSoKT/';
        $inputs['url_qd'] = '/KhenThuongDoiNgoai/HoSoKT/';
        $inputs['phanloaihoso'] = 'dshosothiduakhenthuong';
        $inputs['phanloaikhenthuong'] = 'KHENTHUONG';
        ...
        return view('NghiepVu.KhenThuongDoiNgoai.HoSoKT.ThayDoi')
            ->with('model', $model)
    ...
    public function XemHoSo(Request $request)
    {
        ...
        return view('NghiepVu.KhenThuongDoiNgoai.HoSoKT.Xem')
            ->with('model', $model)
            ->with('model_canhan', $model_canhan)
            ->with('model_tapthe', $model_tapthe)
    ...
    public function InHoSoPD(Request $request)
    {
        ...
        $m_donvi = dsdonvi::where('madonvi', $model->madonvi)->first();
        $a_dhkt = getDanhHieuKhenThuong('ALL');
        return view('NghiepVu.KhenThuongDoiNgoai.HoSoKT.InHoSoKT')
            ->with('model', $model)
            ->with('model_canhan', $model_canhan)
            ->with('model_tapthe', $model_tapthe)
            ->with('model_detai', $model_detai)
    ...
    {
        if (!chkPhanQuyen('dshosokhenthuongdoingoai', 'hoanthanh')) {
            return view('errors.noperm')->with('machucnang', 'dshosokhenthuongdoingoai')->with('tenphanquyen', 'hoanthanh');
        }
        $inputs = $request->all();
    ...
    public function InPhoi(Request $request)
    {
        $inputs = $request->all();
        $inputs['url_hs'] = '/KhenThuongDoiNgoai/HoSoKT/';
        $inputs['url_xd'] = '/KhenThuongDoiNgoai/HoSoKT/';
        $inputs['url_qd'] = '/KhenThuongDoiNgoai/HoSoKT/';
        $model =  dshosothiduakhenthuong::where('mahosotdkt', $inputs['mahosotdkt'])->first();
        $model_canhan = dshosothiduakhenthuong_canhan::where('mahosotdkt', $model->mahosotdkt)->get();
        $model_tapthe = dshosothiduakhenthuong_tapthe::where('mahosotdkt', $model->mahosotdkt)->get();
