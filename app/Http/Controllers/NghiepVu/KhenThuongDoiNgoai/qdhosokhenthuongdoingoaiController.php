...
class qdhosokhenthuongdoingoaiController extends Controller
{
    public static $url = '';
    public function __construct()
    {
        static::$url = '/KhenThuongDoiNgoai/KhenThuong/';
    ...
    {
        if (!chkPhanQuyen('qdhosokhenthuongdoingoai', 'danhsach')) {
            return view('errors.noperm')->with('machucnang', 'qdhosokhenthuongdoingoai')->with('tenphanquyen', 'danhsach');
        }
        $inputs = $request->all();
        ...
        $m_donvi = getDonViXetDuyetHoSo(session('admin')->capdo, null, 'qdhosokhenthuongdoingoai', 'MODEL');
        ...
        $inputs['maloaihinhkt'] = session('chucnang')['qdhosokhenthuongdoingoai']['maloaihinhkt'] ?? 'ALL';
        ...
        //dd($inputs);
        return view('NghiepVu.KhenThuongDoiNgoai.KhenThuong.ThongTin')
            ->with('inputs', $inputs)
            ->with('model', $model)
    ...
    {
        if (!chkPhanQuyen('qdhosokhenthuongdoingoai', 'thaydoi')) {
            return view('errors.noperm')
                ->with('machucnang', 'qdhosokhenthuongdoingoai')
        ...
        $inputs['mahinhthuckt'] = session('chucnang')['qdhosokhenthuongdoingoai']['mahinhthuckt'] ?? 'ALL';
        ...
        return view('NghiepVu.KhenThuongDoiNgoai.KhenThuong.XetKT')
            ->with('model', $model)
    ...
    {
        if (!chkPhanQuyen('qdhosokhenthuongdoingoai', 'hoanthanh')) {
            return view('errors.noperm')
                ->with('machucnang', 'qdhosokhenthuongdoingoai')
    ...
    public function Sua(Request $request)
    {
        ...
        $a_canhan = array_column(dmnhomphanloai_chitiet::wherein('manhomphanloai', ['CANHAN'])->get()->toarray(), 'tenphanloai', 'maphanloai');
        $m_phongtrao = dsphongtraothidua::all();
        return view('NghiepVu.KhenThuongDoiNgoai.KhenThuong.Sua')
            ->with('model', $model)
            ->with('model_canhan', $model_canhan)
            ->with('model_tapthe', $model_tapthe)
            ->with('model_detai', $model_detai)
