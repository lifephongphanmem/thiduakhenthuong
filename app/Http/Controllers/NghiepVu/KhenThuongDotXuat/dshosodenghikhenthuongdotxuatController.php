...
class dshosodenghikhenthuongdotxuatController extends Controller
{
    public static $url = '';
    public function __construct()
    {
        static::$url = '/KhenThuongDotXuat/HoSo/';
    ...
    {
        if (!chkPhanQuyen('dshosodenghikhenthuongdotxuat', 'danhsach')) {
    ...
    public function ThayDoi(Request $request)
    {
        ...
        $inputs = $request->all();
        $inputs['url'] = '/KhenThuongDotXuat/HoSo/';
        $inputs['url_hs'] = '/KhenThuongDotXuat/HoSo/';
        $inputs['url_xd'] = '/KhenThuongDotXuat/XetDuyet/';
        $inputs['url_qd'] = '/KhenThuongDotXuat/KhenThuong/';
        $inputs['phanloaihoso'] = 'dshosothiduakhenthuong';
        ...
        return view('NghiepVu.KhenThuongDotXuat.HoSo.ThayDoi')
            ...
            ->with('inputs', $inputs)
            ->with('pageTitle', 'Thông tin hồ sơ đề nghị khen thưởng đột xuất');
    }
    ...
    public function ChuyenHoSo(Request $request)
    {
        if (!chkPhanQuyen('dshosodenghikhenthuongdotxuat', 'hoanthanh')) {
            return view('errors.noperm')->with('machucnang', 'dshosodenghikhenthuongdotxuat')->with('tenphanquyen', 'hoanthanh');
        }
        $inputs = $request->all();
        ...
        $inputs['trangthai'] = getTrangThaiChuyenHS(session('chucnang')['dshosodenghikhenthuongdotxuat']['trangthai'] ?? 'CC');
