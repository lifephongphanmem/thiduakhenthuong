    ...
    public function XetKT(Request $request)
    {
        if (!chkPhanQuyen('xdhosokhenthuongnienhan', 'thaydoi')) {
            return view('errors.noperm')
                ->with('machucnang', 'xdhosokhenthuongnienhan')
        ...
        $inputs['url_xd'] = '/KhenThuongNienHan/XetDuyet/';
        $inputs['url_qd'] = '/KhenThuongNienHan/KhenThuong/';
        $inputs['mahinhthuckt'] = session('chucnang')['xdhosokhenthuongnienhan']['mahinhthuckt'] ?? 'ALL';
        ...
        return view('NghiepVu.KhenThuongNienHan.XetDuyet.XetKT')
            ->with('model', $model)
