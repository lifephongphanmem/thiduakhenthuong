...
class CreateDshosodangkyphongtraothiduaTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('dshosodangkyphongtraothidua', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('dshosodangkyphongtraothidua');
    }
}
