...
class CreateDshosochongphapCanhanTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('dshosochongphap_canhan', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('dshosochongphap_canhan');
    }
}
