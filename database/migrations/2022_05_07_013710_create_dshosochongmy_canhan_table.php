...
class CreateDshosochongmyCanhanTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('dshosochongmy_canhan', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('dshosochongmy_canhan');
    }
}
