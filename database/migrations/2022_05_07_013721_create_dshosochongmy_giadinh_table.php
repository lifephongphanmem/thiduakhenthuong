...
class CreateDshosochongmyGiadinhTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('dshosochongmy_giadinh', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('dshosochongmy_giadinh');
    }
}
