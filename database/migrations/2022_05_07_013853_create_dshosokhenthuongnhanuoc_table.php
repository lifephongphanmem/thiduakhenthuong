...
class CreateDshosokhenthuongnhanuocTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('dshosokhenthuongnhanuoc', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('dshosokhenthuongnhanuoc');
    }
}
