...
class CreateDshosokhenthuongtinhTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('dshosokhenthuongtinh', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('dshosokhenthuongtinh');
    }
}
