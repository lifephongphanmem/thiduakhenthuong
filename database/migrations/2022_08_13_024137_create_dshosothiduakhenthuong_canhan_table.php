...
class CreateDshosothiduakhenthuongCanhanTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('dshosothiduakhenthuong_canhan', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('dshosothiduakhenthuong_canhan');
    }
}
