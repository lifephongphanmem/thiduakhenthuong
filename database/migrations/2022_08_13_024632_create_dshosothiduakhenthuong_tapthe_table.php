...
class CreateDshosothiduakhenthuongTaptheTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('dshosothiduakhenthuong_tapthe', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('dshosothiduakhenthuong_tapthe');
    }
}
