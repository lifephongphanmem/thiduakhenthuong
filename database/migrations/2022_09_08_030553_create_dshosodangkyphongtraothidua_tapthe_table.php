...
class CreateDshosodangkyphongtraothiduaTaptheTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('dshosodangkyphongtraothidua_tapthe', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('dshosodangkyphongtraothidua_tapthe');
    }
}
