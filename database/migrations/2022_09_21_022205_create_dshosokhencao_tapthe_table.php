...
class CreateDshosokhencaoTaptheTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('dshosokhencao_tapthe', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('dshosokhencao_tapthe');
    }
}
