...
class CreateDshosothamgiaphongtraotdCanhanTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('dshosothamgiaphongtraotd_canhan', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('dshosothamgiaphongtraotd_canhan');
    }
}
