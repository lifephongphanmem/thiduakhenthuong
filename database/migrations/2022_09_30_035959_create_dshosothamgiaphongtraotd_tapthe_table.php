...
class CreateDshosothamgiaphongtraotdTaptheTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('dshosothamgiaphongtraotd_tapthe', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->integer('stt')->default(1);
            $table->string('mahosothamgiapt')->nullable();
    ...
    {
        Schema::dropIfExists('dshosothamgiaphongtraotd_tapthe');
    }
}
