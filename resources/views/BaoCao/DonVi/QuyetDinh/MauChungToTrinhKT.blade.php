...
<script>
    jQuery(document).ready(function() {
        $('#maduthao').change(function() {
            window.location.href = "{{$inputs['url']}}" +  "ToTrinhHoSoKT?maduthao=" + $('#maduthao').val() + "&mahosotdkt=" + "{{$inputs['mahosotdkt']}}";
        });       
    });
</script>
    ...
    <div class="card card-custom" style="min-height: 600px">
        <div class="card-header flex-wrap border-1 pt-6 pb-0">
            <div class="card-title">
                <h3 class="card-label text-uppercase">Thông tin dự thảo tờ trình phê duyệt khen thưởng</h3>
            </div>
        ...
        <div class="card-body">
            <div class="form-group row">
                <div class="col-md-6">
                    <label style="font-weight: bold">Mẫu dự thảo tờ trình phê duyệt khen thưởng</label>
