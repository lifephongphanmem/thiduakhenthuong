                ...
                <div class="card-body">
                    <div class="d-flex align-items-center p-5">
                        ...
                        <div class="d-flex flex-column">
                            <span class="text-dark text-hover-primary font-weight-bold font-size-h4 mb-3">LỜI CẢM ƠN!</span>
            ...
            <div class="card card-custom mb-8 mb-lg-0">
                <div class="card-body">
                    <div class="d-flex align-items-center p-5">
                        ...
                        <div class="d-flex flex-column">
                            <span class="text-dark text-hover-primary font-weight-bold font-size-h4 mb-3">PHÒNG TKBT II -
                                QUẢN LÝ ĐỊA BÀN CÁC TỈNH PHÍA BẮC</span>
                            <div class="text-dark-75">
                                <p>
                                    <span class="label label-danger label-dot mr-2"></span>
                                    <span style="color:blue">Hoàng Văn Sáng</span>- Số điện thoại: <span style="color:blue">0974 090
                                        556</span>
                                </p>
                                <p>
                                    <span class="label label-danger label-dot mr-2"></span>
                                    <span style="color:blue">Nguyễn Văn Dũng</span>- Số điện thoại: <span style="color:blue">0986
                                        012094</span>
                                </p>
                                <p>
                                    <span class="label label-danger label-dot mr-2"></span>
                                    <span style="color:blue">Ngô Thế Dương</span>- Số điện thoại: <span style="color:blue">0916 678
                                        911</span>
                                </p>
                            </div>
                        </div>
