					...
					<div class="d-flex w-100 flex-center p-15">
						<div class="login-wrapper">
							...
							<div class="text-dark-75">
								<a href="#">
									<img src="assets/media/logos/LIFESOFT.png" class="max-h-75px" alt="" />
								</a>
								<h3 class="mb-8 mt-22 font-weight-bold text-uppercase">Phần mềm thi đua khen thưởng</h3>
						...
						<div class="login-wrapper">
							...
							<div class="login-forgot">
								<div class="text-center mb-10 mb-lg-20">
									...
									<p class="text-muted font-weight-bold">Nhập địa chỉ email để nhận lại mật khẩu đăng nhập</p>
								</div>
								<form class="form text-left" id="kt_login_forgot_form">
									...
									<div class="form-group d-flex flex-wrap flex-center mt-10">
										<button id="kt_login_forgot_submit" class="btn btn-primary btn-pill font-weight-bold px-9 py-4 my-3 mx-2">Hoàn thành</button>
										<button id="kt_login_forgot_cancel" class="btn btn-outline-primary btn-pill font-weight-bold px-9 py-4 my-3 mx-2">Bỏ qua</button>
									</div>
								</form>
							</div>
