                    ...
                    <ul class="menu-subnav">
                        ...
                        <li class="menu-item" aria-haspopup="true">
                            <a href="{{url('/DuThaoQD/ThongTin')}}" class="menu-link">
                                ...
                                <span class="menu-text font-weight-bold">Dự thảo quyết định khen thưởng</span>
                            </a>
                        </li>
                        ...
                        <li class="menu-item" aria-haspopup="true">
                            <a href="{{url('/DMPhanLoai/ThongTin')}}" class="menu-link">
                                ...
                                <span class="menu-text font-weight-bold">Phân loại đối tượng</span>
                            </a>
                        </li>
                    ...
                    <ul class="menu-subnav">
                        ...
                        <li class="menu-item" aria-haspopup="true">
                            <a href="{{url('/ChucNang/ThongTin')}}" class="menu-link">
                                ...
                                <span class="menu-text font-weight-bold">Danh sách chức năng hệ thống</span>
                            </a>
                        </li>
                    </ul>
                </div>
                    ...
                    <ul class="menu-subnav">
                        ...
                        <li class="menu-item" aria-haspopup="true">
                            <a href="/API/TapThe" class="menu-link">
                                ...
                                <span class="menu-text">Tập thể</span>
                            </a>
                        </li>
                        <li class="menu-item" aria-haspopup="true">
                            <a href="/API/PhongTrao" class="menu-link">
                                ...
                                <span class="menu-text">Phong trào</span>
                            </a>
                        </li>
                    </ul>
                </div>
