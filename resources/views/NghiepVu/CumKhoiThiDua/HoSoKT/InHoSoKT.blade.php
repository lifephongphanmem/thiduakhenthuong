...
@section('content')
    <table id="data_header" class="header" width="96%" border="0" cellspacing="0" cellpadding="8"
        ...
        <tr>
            <td colspan="2" style="font-weight: bold;">
                <h4> THÔNG TIN HỒ SƠ KHEN THƯỞNG CỤM, KHỐI THI ĐUA </h4>
            </td>
        </tr>
    </table>
    ...
    <table id="data_body" class="money" cellspacing="0" cellpadding="0" border="0"
        ...
        <tr>
            <td>Tên cụm, khối thi đua: {{ $model->tencumkhoi }}</td>
        </tr>
        <tr>
        ...
        <tr>
            <td>Tên đơn vị quyết định khen thưởng: {{ $model->donvikhenthuong }}</td>
        </tr>
        ...
        <tr>
            <td>Số quyết định khen thưởng: {{ $model->soqd }}</td>
        </tr>
        <tr>
            <td>Ngày quyết định khen thưởng:  {{ getDayVn($model->ngayqd) }}</td>
        </tr>
