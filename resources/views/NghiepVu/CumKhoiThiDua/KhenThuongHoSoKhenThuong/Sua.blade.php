...
@section('content')
    ...
    <div class="card card-custom" style="min-height: 600px">
        ...
        {!! Form::model($model, [
            'method' => 'POST',
            '/CumKhoiThiDua/HoSoKhenThuong/Them',
            'class' => 'form',
            'id' => 'frm_ThayDoi',
            'files' => true,
        ...
        <div class="card-footer">
            <div class="row text-center">
                <div class="col-lg-12">
                    <a href="{{ url('/CumKhoiThiDua/HoSoKhenThuong/DanhSach?madonvi=' . $model->madonvi . '&macumkhoi=' . $model->macumkhoi) }}"
                ...
                <div class="modal-body" id="ttpthemmoi">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            ...
                            {!! Form::select('madanhhieutd', setArrayAll($a_danhhieutd,'Không đăng ký', 'null'), null, ['id' => 'madanhhieutd', 'class' => 'form-control']) !!}
                        </div>
                    </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="control-label">Đăng ký danh hiệu thi đua</label>
                                {!! Form::select('madanhhieutd_kt', setArrayAll($a_danhhieutd,'Không đăng ký', 'null'), null, ['id' => 'madanhhieutd_kt', 'class' => 'form-control']) !!}
                            </div>
                        </div>
                    </div>
