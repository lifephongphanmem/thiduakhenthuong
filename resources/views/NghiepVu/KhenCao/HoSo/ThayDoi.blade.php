        ...
        function deleteRow() {
            ...
            $.ajax({
                ...
                data: {
                    ...
                    madonvi: $('#madonvi').val(),
                    mahosokt: $('#frm_ThayDoi').find("[name='mahosokt']").val()
                },
                dataType: 'JSON',
                success: function(data) {
...
@section('content')
    ...
    <div class="card card-custom" style="min-height: 600px">
        ...
        {!! Form::model($model, ['method' => 'POST', 'url' => '/KhenCao/HoSo/Sua', 'class' => 'form', 'id' => 'frm_ThayDoi', 'files' => true, 'enctype' => 'multipart/form-data']) !!}
        ...
        <div class="card-footer">
            <div class="row text-center">
                <div class="col-lg-12">
                    <a href="{{ url('/KhenCao/HoSo/ThongTin?madonvi=' . $model->madonvi) }}"
    ...
    {{-- Cá nhân --}}
    {!! Form::open(['url' => '/KhenCao/HoSo/CaNhan', 'id' => 'frm_ThemCaNhan', 'class' => 'form', 'files' => true, 'enctype' => 'multipart/form-data']) !!}
    <input type="hidden" name="madoituong" id="madoituong" />
    <input type="hidden" name="mahosotdkt"  />
    <input type="hidden" name="mahosokt" value="{{ $model->mahosokt }}" />
    ...
    {{-- tập thể --}}
    {!! Form::open(['url' => '/KhenCao/HoSo/TapThe', 'id' => 'frm_ThemTapThe', 'class' => 'form', 'files' => true, 'enctype' => 'multipart/form-data']) !!}
    <input type="hidden" name="mahosokt" value="{{ $model->mahosokt }}" />
    <input type="hidden" name="mahosotdkt"  />
    ...
    {!! Form::open(['url' => '/KhenCao/HoSo/XoaDoiTuong', 'id' => 'frm_ThemTapThe', 'class' => 'form', 'files' => true, 'enctype' => 'multipart/form-data']) !!}
