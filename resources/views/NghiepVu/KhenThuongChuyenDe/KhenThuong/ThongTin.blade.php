        ...
        jQuery(document).ready(function() {
            ...
            $('#madonvi, #nam, #phanloai, #trangthaihoso').change(function() {
                window.location.href = "{{ $inputs['url_qd'] }}" +
                    ...
                    '&nam=' + $('#nam').val() + "&phanloai=" + $('#phanloai').val() + "&trangthaihoso=" +
                     $('#trangthaihoso').val();
            });
        });
    </script>
                            ...
                            <tr>
                                ...
                                <td style="text-align: center">
                                    ...
                                    @if ($inputs['trangthai'] == 'CC')
                                        ...
                                        @endif
                                    @else
                                        @if ($tt->trangthai == 'CXKT' && chkPhanQuyen('qdhosodenghikhenthuongchuyende', 'hoanthanh'))
                                        ...
                                        @if ($tt->trangthai == 'DKT' && chkPhanQuyen('qdhosodenghikhenthuongchuyende', 'hoanthanh'))
                                            <button title="Hủy phê duyệt hồ sơ khen thưởng" type="button"
                                                onclick="setHuyPheDuyet('{{ $tt->mahosotdkt }}')"
                                                class="btn btn-sm btn-clean btn-icon" data-target="#modal-HuyPheDuyet"
                                                data-toggle="modal">
