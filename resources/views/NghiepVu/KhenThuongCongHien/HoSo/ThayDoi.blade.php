...
@section('content')
    ...
    <div class="card card-custom" style="min-height: 600px">
        ...
        {!! Form::model($model, [
            'method' => 'POST',
            'url' => '/KhenThuongCongTrang/HoSoKhenThuong/Sua',
            'class' => 'form',
            'id' => 'frm_ThayDoi',
            'files' => true,
    ...
    {{-- Cá nhân --}}
    {!! Form::open([
        'url' => '/KhenThuongCongTrang/HoSoKhenThuong/CaNhan',
        'id' => 'frm_ThemCaNhan',
        'class' => 'form',
        'files' => true,
        'enctype' => 'multipart/form-data',
    ...
    {{-- tập thể --}}
    {!! Form::open([
        'url' => '/KhenThuongCongTrang/HoSoKhenThuong/TapThe',
        'id' => 'frm_ThemTapThe',
        'class' => 'form',
        'files' => true,
        'enctype' => 'multipart/form-data',
    ...
    {!! Form::open([
        'url' => '/KhenThuongCongTrang/HoSoKhenThuong/NhanExcel',
        'id' => 'frm_NhanExcel',
        'class' => 'form',
        'files' => true,
        'enctype' => 'multipart/form-data',
