    ...
    <script>
        jQuery(document).ready(function() {
            ...
            $('#madonvi').change(function() {
                window.location.href = '/KhenThuongDotXuat/KhenThuong/ThongTin?madonvi=' + $(
                        '#madonvi').val() +
                                ...
                                <td style="text-align: center">
                                    ...
                                    @if ($tt->trangthai == 'DXKT')
                                        <a title="Thông tin hồ sơ khen thưởng"
                                            href="{{ url('/KhenThuongDotXuat/KhenThuong/DanhSach?mahosokt=' . $tt->mahosokt) }}"
                                        ...
                                        <a title="In quyết định khen thưởng"
                                            href="{{ url('/KhenThuongDotXuat/KhenThuong/QuyetDinh?mahosokt=' . $tt->mahosokt) }}"
                                            class="btn btn-sm btn-clean btn-icon">
                                    ...
                                    @if ($tt->trangthai == 'DKT')
                                        <a title="Thông tin hồ sơ khen thưởng"
                                            ...
                                            <i class="icon-lg la fa-user-check text-dark"></i></a>
                                        <a title="In quyết định khen thưởng"
                                            href="{{ url('/KhenThuongDotXuat/KhenThuong/XemQuyetDinh?mahosokt=' . $tt->mahosokt) }}"
                                            class="btn btn-sm btn-clean btn-icon" target="_blank">
                                            <i class="icon-lg la fa-print text-dark"></i></a>
                                    @endif
    ...
    <div class="modal fade" id="modal-PheDuyet" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                {!! Form::open(['url' => '/KhenThuongDotXuat/KhenThuong/PheDuyet', 'method' => 'post', 'files' => true, 'id' => 'frm_PheDuyet', 'class' => 'form-horizontal', 'enctype' => 'multipart/form-data']) !!}
