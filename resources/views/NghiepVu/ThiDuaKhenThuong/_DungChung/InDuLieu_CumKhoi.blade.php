        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div id="div_inHoSo">
                    <div class="row">
                        <div class="col-lg-12">
                            <a onclick="setInKT($(this), '{{ $inputs['url_hs'] }}')"
                                class="btn btn-sm btn-clean text-dark font-weight-bold" target="_blank">
                ...
                <div id="div_inHoSoDN">
                    {{-- <div class="row">
                        <div class="col-lg-12">
                            <a onclick="setInKT($(this), '{{$inputs['url_xd'] ?? 'XetDuyet'}}')"
                                class="btn btn-sm btn-clean text-dark font-weight-bold" target="_blank">
                                <i class="la flaticon2-print"></i>Thông tin hồ sơ đề nghị khen thưởng
                            </a>
                        </div>
                    ...
                    {{-- <div class="row">
                        <div class="col-lg-12">
                            <a onclick="setInKT($(this), '{{ $inputs['url_xd'] }}')"
                                class="btn btn-sm btn-clean text-dark font-weight-bold" target="_blank">
                                <i class="la flaticon2-print"></i>Thông tin hồ sơ xét duyệt khen thưởng
                            </a>
                        </div>
                    </div> --}}
                ...
                <div id="div_inDuLieu">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <a id="btnInQD" onclick="setInQD($(this), '{{ $inputs['url_qd'] . 'InQuyetDinh'}}')"
                                class="btn btn-sm btn-clean text-dark font-weight-bold" target="_blank">
