    ...
    <script>
        jQuery(document).ready(function() {
            ...
            $('#madonvi').change(function() {
                window.location.href = "{{ $inputs['url'] }}" + "CaNhan/ThongTin?madonvi=" + $('#madonvi').val();
            });
...
@section('content')
    ...
    {!! Form::open([
        'method' => 'POST',
        'url' => '/TraCuu/KhenCao/CaNhan/ThongTin',
        'class' => 'form',
        'id' => 'frm_ThayDoi',
        'files' => true,
    ...
    <div class="card card-custom wave wave-animate-slow wave-info">
        <div class="card-header">
            <div class="card-title">
                <h3 class="card-label text-uppercase">Thông tin tìm kiếm kết quả khen cao theo cá nhân</h3>
            </div>
