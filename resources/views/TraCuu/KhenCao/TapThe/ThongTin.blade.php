...
@section('content')
    ...
    {!! Form::open(['method' => 'POST', 'url' => '/TraCuu/KhenCao/TapThe/ThongTin', 'class' => 'form', 'id' => 'frm_ThayDoi', 'files' => true, 'enctype' => 'multipart/form-data']) !!}
    <div class="card card-custom wave wave-animate-slow wave-info" style="min-height: 600px">
        <div class="card-header">
            <div class="card-title">
                <h3 class="card-label text-uppercase">Thông tin tìm kiếm kết quả khen cao theo tập thể</h3>
            </div>
