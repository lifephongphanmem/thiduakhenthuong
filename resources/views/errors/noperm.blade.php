	...
	<body id="kt_body" class="header-mobile-fixed subheader-enabled aside-enabled aside-fixed aside-secondary-enabled page-loading">
		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="d-flex flex-row-fluid flex-column bgi-size-cover bgi-position-center bgi-no-repeat p-10 p-sm-30" style="background-image: url(assets/media/error/bg1.jpg);">
				...
				<p class="font-size-h3 text-danger font-weight-normal">{!! isset($message) ? $message : 'Chức năng đang bị khóa hoặc không tồn tại.<br> Bạn hãy liên hệ người quản trị để kiểm tra tính năng này trên hệ thống.'!!} </p>
